<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 35px; text-align: center; margin-bottom: 20px; color: #333333">谢佳晨的影评</div>
...
<script setup>
  ...
  const data = reactive({
    form: { role: 'USER',username:'xiejiachen',password:'123456' },
    rules: {
      username: [
